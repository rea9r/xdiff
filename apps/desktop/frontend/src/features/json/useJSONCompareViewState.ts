...
import type { CompareJSONRichResponse, JSONRichDiffItem } from '../../types'
...
type UseJSONCompareViewStateOptions = {
  jsonRichResult: CompareJSONRichResponse | null
  jsonOldText: string
  jsonNewText: string
...
export function useJSONCompareViewState({
  jsonRichResult,
  jsonOldText,
  jsonNewText,
  textDiffLayout,
}: UseJSONCompareViewStateOptions) {
